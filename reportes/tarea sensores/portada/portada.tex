	...
	\begin{center}
		\begin{tabular}{c c}
			\begin{tabular}{c}
				...
				\textbf{Moreno},\\ Miguel \\ \texttt{L21330649@hermosillo.tecnm.mx} \\ Teléfono: (opcional)
			\end{tabular} &
			\begin{tabular}{c}
				\includegraphics[height=3cm]{perfil2.jpg} \\
				\textbf{Ortega,}\\ Jason \\ \texttt{L21330663@hermosillo.tecnm.mx} \\ Teléfono: (opcional)
			\end{tabular} \\ \vspace{2em}
			\begin{tabular}{c}
				\includegraphics[height=3cm]{perfil3.jpg} \\
				\textbf{Romero,}\\ Ignacio \\ \texttt{L21330680@hermosillo.tecnm.mx} \\ Teléfono: (opcional)
			\end{tabular} &
			\begin{tabular}{c}
				\includegraphics[height=3cm]{sensorlaser.jpg} \\
				\textbf{Valenzuela,}\\ Horacio \\ \texttt{L21330705@hermosillo.tecnm.mx} \\ Teléfono: (opcional)
			\end{tabular}
		\end{tabular}
	\end{center}
